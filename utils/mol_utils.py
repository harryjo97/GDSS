...
ATOM_VALENCY = {5:3,6: 4, 7: 3, 8: 2, 9: 1, 15: 3, 16: 2, 17: 1, 35: 1, 53: 1, 11:1}
bond_decoder = {1: Chem.rdchem.BondType.SINGLE, 2: Chem.rdchem.BondType.DOUBLE, 3: Chem.rdchem.BondType.TRIPLE}
AN_TO_SYMBOL = {5:'B',6: 'C', 7: 'N', 8: 'O', 9: 'F',11:'Na', 15: 'P', 16: 'S', 17: 'Cl', 35: 'Br', 53: 'I'}
...
def gen_mol(x, adj, dataset, largest_connected_comp=True):    
    ...
    if dataset == 'QM9':
        ...
        atomic_num_list = [5,6, 7, 8, 9, 11,15, 16, 17, 35, 53, 0]
